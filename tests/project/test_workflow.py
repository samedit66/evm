...
from evm.operations.autotest import AutoTestCase, AutoTestDiagnostic, AutoTestExecution
from evm.operations.tasks import run_task
from evm.operations.testing import TestRequest as WorkflowTestRequest
from evm.operations.testing import _find_assertion_line, _parse_getest_summary
...
""",
    ...
    monkeypatch.setattr(
        "evm.operations.testing.select_toolchain", lambda project, compiler: toolchain
    )
    monkeypatch.setattr(
        "evm.operations.testing.compile_project",
        lambda project, request, announce: toolchain,
    )
    monkeypatch.setattr(
        "evm.operations.testing.artifact_candidates",
        lambda toolchain, project, request: (executable,),
    )
    process_options = []
    monkeypatch.setattr(
        "evm.operations.testing.subprocess.run",
...
""",
    ...
    monkeypatch.setattr(
        "evm.operations.testing.run_autotest",
...
""",
    ...
    monkeypatch.setattr("evm.operations.testing.shutil.which", lambda executable: "/tools/getest")
    monkeypatch.setattr(
        "evm.operations.testing.prepare_project", lambda *arguments, **options: None
    )
    monkeypatch.setattr(
        "evm.operations.testing.subprocess.run",
...
""",
    ...
    monkeypatch.setattr(
        "evm.operations.testing.select_toolchain",
